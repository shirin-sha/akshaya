                ...
                <div className="container">
                    <nav className="main-menu">
                        <div className="main-menu-logo">
                            <Link href="/">
                                <Image src={Logob01} alt="header-logo" layout='intrinsic'/>
                            </Link>
                        </div>
                        ...
                        <div className={`main-menu-right ${isSearchActive ? "active" : ""}`}>
                            ...
                            <Link href="tel:+020.098.45611" className="menu-phone">
                                {" "}
                ...
                <div className={`mobile-nav-wrapper ${isMenuExpanded ? "expanded" : ""}`}>
                    ...
                    <div className="mobile-nav-content">
                        ...
                        <div className="logo-box">
                            <Link href="/">
                                <Image width={150} src={Logo02} alt="logo" layout='intrinsic'/>
                            </Link>
                        </div>
